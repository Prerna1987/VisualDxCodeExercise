...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout myContainer,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.myContainer;
      FrameLayout myContainer = ViewBindings.findChildViewById(rootView, id);
      if (myContainer == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, myContainer, navBar);
    }
